    ...
    public void onSmelt(FurnaceSmeltEvent e) {
        if (BlockStorage.check(e.getBlock()) != null && BlockStorage.check(e.getBlock()) instanceof EnhancedFurnace) {
            ...
            if (result != null) {
                ...
                f.getInventory().setResult(new CustomItem(output, (output.getAmount() + amount > output.getType().getMaxStackSize()) ? output.getType().getMaxStackSize() : (output.getAmount() + amount)));
            }
