...
public class SlimefunSetup {
    ...
    public static void setupItems() {
        ...
        new SlimefunItem(Categories.WEAPONS, SlimefunItems.GRANDPAS_WALKING_STICK, "GRANDPAS_WALKING_STICK2", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{new ItemStack(Material.LEATHER), new ItemStack(Material.LOG_2), new ItemStack(Material.LEATHER), null, new ItemStack(Material.LOG_2), null, null, new ItemStack(Material.LOG_2), null}, true).register(true);
        ...
        new SlimefunMachine(Categories.MACHINES_1, SlimefunItems.ENHANCED_CRAFTING_TABLE, "ENHANCED_CRAFTING_TABLE", new ItemStack[]{null, null, null, null, new ItemStack(Material.WORKBENCH), null, null, new ItemStack(Material.DISPENSER), null}, new ItemStack[0], Material.WORKBENCH).register(true, new MultiBlockInteractionHandler() {
            @Override
            public boolean onInteract(final Player p, final MultiBlock mb, final Block b) {
                final SlimefunMachine machine = (SlimefunMachine) SlimefunItem.getByID("ENHANCED_CRAFTING_TABLE");
                            ...
                            if (craft) {
                                ...
                                if (Slimefun.hasUnlocked(p, adding, true)) {
                                    ...
                                    for (int k = 0; k < inv.getContents().length; ++k) {
                                        inv2.setItem(k, (inv.getContents()[k] != null) ? ((inv.getContents()[k].getAmount() > 1) ? new CustomItem(inv.getContents()[k], inv.getContents()[k].getAmount() - 1) : null) : null);
                                    }
                                    if (InvUtils.fits(inv2, adding)) {
                                        final SlimefunItem sfItem = SlimefunItem.getByItem(adding);
                                        if (sfItem instanceof SlimefunBackpack) {
                                            ItemStack backpack = null;
                                            for (int l = 0; l < 9; ++l) {
                                                if (inv.getContents()[l] != null && inv.getContents()[l].getType() != Material.AIR && SlimefunItem.getByItem(inv.getContents()[l]) instanceof SlimefunBackpack) {
                                                    backpack = inv.getContents()[l];
                                                    break;
                                                }
                                            }
                                            String id = "";
                                            final int size = ((SlimefunBackpack) sfItem).size;
                                            if (backpack != null) {
                                                for (final String line : backpack.getItemMeta().getLore()) {
                                                    if (line.startsWith(ChatColor.translateAlternateColorCodes('&', "&7ID: ")) && line.contains("#")) {
                                                        id = line.replace(ChatColor.translateAlternateColorCodes('&', "&7ID: "), "");
                                                        final Config cfg = new Config(new File("data-storage/Slimefun/Players/" + id.split("#")[0] + ".yml"));
                                            ...
                                            if ("".equals(id)) {
                                                for (int line2 = 0; line2 < adding.getItemMeta().getLore().size(); ++line2) {
                                                    if (adding.getItemMeta().getLore().get(line2).equals(ChatColor.translateAlternateColorCodes('&', "&7ID: <ID>"))) {
                                                        ...
                                                        lore.set(line2, lore.get(line2).replace("<ID>", Backpacks.createBackpack(p, size)));
                                                        im.setLore(lore);
                                                ...
                                                for (int line2 = 0; line2 < adding.getItemMeta().getLore().size(); ++line2) {
                                                    if (adding.getItemMeta().getLore().get(line2).equals(ChatColor.translateAlternateColorCodes('&', "&7ID: <ID>"))) {
                                                        final ItemMeta im = adding.getItemMeta();
                                                        final List<String> lore = im.getLore();
                                                        lore.set(line2, lore.get(line2).replace("<ID>", id));
                                                        im.setLore(lore);
                                                        adding.setItemMeta(im);
                                                        break;
                                                    }
                                        ...
                                        for (int m = 0; m < 9; ++m) {
                                            if (inv.getContents()[m] != null && inv.getContents()[m].getType() != Material.AIR) {
                                                if (inv.getContents()[m].getType().toString().endsWith("_BUCKET")) {
                                                    inv.setItem(m, new ItemStack(Material.BUCKET));
                                                } else if (inv.getContents()[m].getAmount() > 1) {
                                                    inv.setItem(m, new CustomItem(inv.getContents()[m], inv.getContents()[m].getAmount() - 1));
                                                } else {
                                                    inv.setItem(m, null);
                                                }
                                            }
        ...
        new SlimefunItem(Categories.PORTABLE, SlimefunItems.PORTABLE_DUSTBIN, "PORTABLE_DUSTBIN", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{new ItemStack(Material.IRON_INGOT), new ItemStack(Material.IRON_INGOT), new ItemStack(Material.IRON_INGOT), new ItemStack(Material.IRON_INGOT), null, new ItemStack(Material.IRON_INGOT), new ItemStack(Material.IRON_INGOT), new ItemStack(Material.IRON_INGOT), new ItemStack(Material.IRON_INGOT)}).register(true, new ItemInteractionHandler() {
            ...
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack item) {
                if (SlimefunManager.isItemSimiliar(item, SlimefunItems.PORTABLE_DUSTBIN, true)) {
                    e.setCancelled(true);
                    p.openInventory(Bukkit.createInventory(null, 27, ChatColor.DARK_RED + "删除物品"));
        ...
        new SlimefunMachine(Categories.MACHINES_1, SlimefunItems.ARMOR_FORGE, "ARMOR_FORGE", new ItemStack[]{null, null, null, null, new ItemStack(Material.ANVIL), null, null, new CustomItem(Material.DISPENSER, "发射器 (口朝上)", 0), null}, new ItemStack[0], Material.ANVIL).register(true, new MultiBlockInteractionHandler() {
            @Override
            public boolean onInteract(final Player p, final MultiBlock mb, final Block b) {
                final SlimefunMachine machine = (SlimefunMachine) SlimefunItem.getByID("ARMOR_FORGE");
                if (mb.isMultiBlock(machine)) {
                    if (CSCoreLib.getLib().getProtectionManager().canAccessChest(p.getUniqueId(), b, true) && Slimefun.hasUnlocked(p, machine.getItem(), true)) {
                        final Dispenser disp = (Dispenser) b.getRelative(BlockFace.DOWN).getState();
                        final Inventory inv = disp.getInventory();
        ...
        new SlimefunItem(Categories.FOOD, SlimefunItems.MAGIC_SUGAR, "MAGIC_SUGAR", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{new ItemStack(Material.SUGAR), new ItemStack(Material.REDSTONE), new ItemStack(Material.GLOWSTONE_DUST), null, null, null, null, null, null}, new String[]{"effects.SPEED"}, new Integer[]{4}).register(true, new ItemInteractionHandler() {
            ...
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack item) {
                if (SlimefunManager.isItemSimiliar(item, SlimefunItems.MAGIC_SUGAR, true)) {
                    ...
                    p.addPotionEffect(new PotionEffect(PotionEffectType.SPEED, 600, (int) Slimefun.getItemValue("MAGIC_SUGAR", "effects.SPEED")));
                    return true;
                }
                return false;
            }
        ...
        new SlimefunGadget(Categories.TOOLS, SlimefunItems.GOLD_PAN, "GOLD_PAN", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{null, null, null, new ItemStack(Material.STONE), new ItemStack(Material.BOWL), new ItemStack(Material.STONE), new ItemStack(Material.STONE), new ItemStack(Material.STONE), new ItemStack(Material.STONE)}, new ItemStack[]{new ItemStack(Material.GRAVEL), new ItemStack(Material.FLINT), new ItemStack(Material.GRAVEL), new ItemStack(Material.CLAY_BALL), new ItemStack(Material.GRAVEL), SlimefunItems.SIFTED_ORE}, new String[]{"chance.FLINT", "chance.CLAY", "chance.SIFTED_ORE"}, new Integer[]{47, 28, 15}).register(true, new ItemInteractionHandler() {
            ...
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack item) {
                ...
                if (ProtectionUtils.canBuild(p, e.getClickedBlock())) {
                    ...
                    if (SlimefunStartup.chance(100, (int) Slimefun.getItemValue("GOLD_PAN", "chance.SIFTED_ORE"))) {
                        drops.add(SlimefunItems.SIFTED_ORE);
                    } else if (SlimefunStartup.chance(100, (int) Slimefun.getItemValue("GOLD_PAN", "chance.CLAY"))) {
                        drops.add(new ItemStack(Material.CLAY_BALL));
                    } else if (SlimefunStartup.chance(100, (int) Slimefun.getItemValue("GOLD_PAN", "chance.FLINT"))) {
        ...
        new SlimefunMachine(Categories.MACHINES_1, SlimefunItems.SMELTERY, "SMELTERY", new ItemStack[]{null, new ItemStack(Material.NETHER_FENCE), null, new ItemStack(Material.NETHER_BRICK), new CustomItem(Material.DISPENSER, "发射器 (口朝上)", 0), new ItemStack(Material.NETHER_BRICK), null, new ItemStack(Material.FLINT_AND_STEEL), null}, new ItemStack[]{SlimefunItems.IRON_DUST, new ItemStack(Material.IRON_INGOT)}, Material.NETHER_FENCE, new String[]{"chance.fireBreak"}, new Integer[]{34}).register(true, new MultiBlockInteractionHandler() {
            @Override
            public boolean onInteract(final Player p, final MultiBlock mb, final Block b) {
                final SlimefunMachine machine = (SlimefunMachine) SlimefunItem.getByID("SMELTERY");
                if (mb.isMultiBlock(machine)) {
                    if (CSCoreLib.getLib().getProtectionManager().canAccessChest(p.getUniqueId(), b, true) && Slimefun.hasUnlocked(p, machine.getItem(), true)) {
                        final Dispenser disp = (Dispenser) b.getRelative(BlockFace.DOWN).getState();
                        final Inventory inv = disp.getInventory();
                            ...
                            if (craft) {
                                ...
                                if (Slimefun.hasUnlocked(p, adding, true)) {
                                    if (InvUtils.fits(inv, adding)) {
                                        ...
                                        final Block raw_disp = b.getRelative(BlockFace.DOWN);
                                        Hopper chamber = null;
                                        ...
                                        if (SlimefunStartup.chance(100, (int) Slimefun.getItemValue("SMELTERY", "chance.fireBreak"))) {
                                            if (chamber != null) {
                                                if (chamber.getInventory().contains(Material.FLINT_AND_STEEL)) {
                                                    final ItemStack item = chamber.getInventory().getItem(chamber.getInventory().first(Material.FLINT_AND_STEEL));
                                                    ...
                                                    final Block fire = b.getRelative(BlockFace.DOWN).getRelative(BlockFace.DOWN);
        ...
        new SlimefunMachine(Categories.MACHINES_1, SlimefunItems.PRESSURE_CHAMBER, "PRESSURE_CHAMBER", new ItemStack[]{new ItemStack(Material.STEP), new CustomItem(Material.DISPENSER, "发射器 (口朝下)", 0), new ItemStack(Material.STEP), new ItemStack(Material.PISTON_BASE), new ItemStack(Material.GLASS), new ItemStack(Material.PISTON_BASE), new ItemStack(Material.PISTON_BASE), new ItemStack(Material.CAULDRON_ITEM), new ItemStack(Material.PISTON_BASE)}, new ItemStack[]{SlimefunItems.CARBON_CHUNK, SlimefunItems.SYNTHETIC_DIAMOND, SlimefunItems.RAW_CARBONADO, SlimefunItems.CARBONADO}, Material.CAULDRON).register(true, new MultiBlockInteractionHandler() {
            @Override
            public boolean onInteract(final Player p, final MultiBlock mb, final Block b) {
                final SlimefunMachine machine = (SlimefunMachine) SlimefunItem.getByID("PRESSURE_CHAMBER");
                if (mb.isMultiBlock(machine)) {
                    if (CSCoreLib.getLib().getProtectionManager().canAccessChest(p.getUniqueId(), b, true) && Slimefun.hasUnlocked(p, machine.getItem(), true)) {
                        final Dispenser disp = (Dispenser) b.getRelative(BlockFace.UP).getRelative(BlockFace.UP).getState();
                        final Inventory inv = disp.getInventory();
                        for (final ItemStack current : inv.getContents()) {
                            for (final ItemStack convert : RecipeType.getRecipeInputs(machine)) {
                                if (convert != null && SlimefunManager.isItemSimiliar(current, convert, true)) {
        ...
        new Jetpack(SlimefunItems.DURALUMIN_JETPACK, "DURALUMIN_JETPACK", new ItemStack[]{SlimefunItems.DURALUMIN_INGOT, new CustomItem(SlimefunItems.CARBONADO, 64), SlimefunItems.DURALUMIN_INGOT, SlimefunItems.DURALUMIN_INGOT, SlimefunItems.POWER_CRYSTAL, SlimefunItems.DURALUMIN_INGOT, SlimefunItems.STEEL_THRUSTER, SlimefunItems.SMALL_CAPACITOR, SlimefunItems.STEEL_THRUSTER}, 0.35).register(true);
        new Jetpack(SlimefunItems.SOLDER_JETPACK, "SOLDER_JETPACK", new ItemStack[]{SlimefunItems.SOLDER_INGOT, new CustomItem(SlimefunItems.CARBONADO, 64), SlimefunItems.SOLDER_INGOT, SlimefunItems.SOLDER_INGOT, SlimefunItems.POWER_CRYSTAL, SlimefunItems.SOLDER_INGOT, SlimefunItems.STEEL_THRUSTER, SlimefunItems.SMALL_CAPACITOR, SlimefunItems.STEEL_THRUSTER}, 0.4).register(true);
        new Jetpack(SlimefunItems.BILLON_JETPACK, "BILLON_JETPACK", new ItemStack[]{SlimefunItems.BILLON_INGOT, new CustomItem(SlimefunItems.CARBONADO, 64), SlimefunItems.BILLON_INGOT, SlimefunItems.BILLON_INGOT, SlimefunItems.POWER_CRYSTAL, SlimefunItems.BILLON_INGOT, SlimefunItems.STEEL_THRUSTER, SlimefunItems.SMALL_CAPACITOR, SlimefunItems.STEEL_THRUSTER}, 0.45).register(true);
        new Jetpack(SlimefunItems.STEEL_JETPACK, "STEEL_JETPACK", new ItemStack[]{SlimefunItems.STEEL_INGOT, new CustomItem(SlimefunItems.CARBONADO, 64), SlimefunItems.STEEL_INGOT, SlimefunItems.STEEL_INGOT, SlimefunItems.POWER_CRYSTAL, SlimefunItems.STEEL_INGOT, SlimefunItems.STEEL_THRUSTER, SlimefunItems.SMALL_CAPACITOR, SlimefunItems.STEEL_THRUSTER}, 0.5).register(true);
        new Jetpack(SlimefunItems.DAMASCUS_STEEL_JETPACK, "DAMASCUS_STEEL_JETPACK", new ItemStack[]{SlimefunItems.DAMASCUS_STEEL_INGOT, new CustomItem(SlimefunItems.CARBONADO, 64), SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.POWER_CRYSTAL, SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.STEEL_THRUSTER, SlimefunItems.SMALL_CAPACITOR, SlimefunItems.STEEL_THRUSTER}, 0.55).register(true);
        new Jetpack(SlimefunItems.REINFORCED_ALLOY_JETPACK, "REINFORCED_ALLOY_JETPACK", new ItemStack[]{SlimefunItems.REINFORCED_ALLOY_INGOT, new CustomItem(SlimefunItems.CARBONADO, 64), SlimefunItems.REINFORCED_ALLOY_INGOT, SlimefunItems.REINFORCED_ALLOY_INGOT, SlimefunItems.POWER_CRYSTAL, SlimefunItems.REINFORCED_ALLOY_INGOT, SlimefunItems.STEEL_THRUSTER, SlimefunItems.MEDIUM_CAPACITOR, SlimefunItems.STEEL_THRUSTER}, 0.6).register(true);
        new Jetpack(SlimefunItems.CARBONADO_JETPACK, "CARBONADO_JETPACK", new ItemStack[]{SlimefunItems.CARBON_CHUNK, new CustomItem(SlimefunItems.CARBONADO, 64), SlimefunItems.CARBON_CHUNK, SlimefunItems.CARBONADO, SlimefunItems.POWER_CRYSTAL, SlimefunItems.CARBONADO, SlimefunItems.STEEL_THRUSTER, SlimefunItems.LARGE_CAPACITOR, SlimefunItems.STEEL_THRUSTER}, 0.7).register(true);
            ...
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack item) {
                if (SlimefunManager.isItemSimiliar(item, SlimefunItems.GRAPPLING_HOOK, true)) {
                    if (e.getClickedBlock() == null && !Variables.jump.containsKey(p.getUniqueId())) {
                        ...
                        if (p.getInventory().getItemInMainHand().getType() == Material.LEASH) {
                            PlayerInventory.consumeItemInHand(p);
                        }
                        final Vector direction = p.getEyeLocation().getDirection().multiply(2.0);
                        final Projectile projectile = (Projectile) p.getWorld().spawn(p.getEyeLocation().add(direction.getX(), direction.getY(), direction.getZ()), (Class) Arrow.class);
        ...
        new SlimefunMachine(Categories.MACHINES_1, SlimefunItems.MAGIC_WORKBENCH, "MAGIC_WORKBENCH", new ItemStack[]{null, null, null, null, null, null, new ItemStack(Material.BOOKSHELF), new ItemStack(Material.WORKBENCH), new ItemStack(Material.DISPENSER)}, new ItemStack[0], Material.WORKBENCH).register(true, new MultiBlockInteractionHandler() {
            @Override
            public boolean onInteract(final Player p, final MultiBlock mb, final Block b) {
                final SlimefunMachine machine = (SlimefunMachine) SlimefunItem.getByID("MAGIC_WORKBENCH");
                if (mb.isMultiBlock(machine)) {
                    if (CSCoreLib.getLib().getProtectionManager().canAccessChest(p.getUniqueId(), b, true) && Slimefun.hasUnlocked(p, machine.getItem(), true)) {
                        Dispenser disp = null;
                            ...
                            if (craft) {
                                ...
                                if (Slimefun.hasUnlocked(p, adding, true)) {
                                    ...
                                    if (InvUtils.fits(inv2, adding)) {
                                        ...
                                        for (int m = 0; m < 9; ++m) {
                                            if (inv.getContents()[m] != null && inv.getContents()[m].getType() != Material.AIR) {
                                                if (inv.getContents()[m].getAmount() > 1) {
                                                    inv.setItem(m, new CustomItem(inv.getContents()[m], inv.getContents()[m].getAmount() - 1));
                                                } else {
                                                    inv.setItem(m, null);
                                                }
                ...
                if (SlimefunManager.isItemSimiliar(item, SlimefunItems.STAFF_WIND, true)) {
                    if (p.getFoodLevel() >= 2) {
                        if (p.getInventory().getItemInMainHand().getType() != Material.SHEARS && p.getGameMode() != GameMode.CREATIVE) {
                            final FoodLevelChangeEvent event = new FoodLevelChangeEvent(p, p.getFoodLevel() - 2);
        ...
        new SlimefunMachine(Categories.MACHINES_1, SlimefunItems.ORE_WASHER, "ORE_WASHER", new ItemStack[]{null, new ItemStack(Material.DISPENSER), null, null, new ItemStack(Material.FENCE), null, null, new ItemStack(Material.CAULDRON_ITEM), null}, new ItemStack[]{SlimefunItems.SIFTED_ORE, SlimefunItems.IRON_DUST, SlimefunItems.SIFTED_ORE, SlimefunItems.GOLD_DUST, SlimefunItems.SIFTED_ORE, SlimefunItems.COPPER_DUST, SlimefunItems.SIFTED_ORE, SlimefunItems.TIN_DUST, SlimefunItems.SIFTED_ORE, SlimefunItems.ZINC_DUST, SlimefunItems.SIFTED_ORE, SlimefunItems.ALUMINUM_DUST, SlimefunItems.SIFTED_ORE, SlimefunItems.MAGNESIUM_DUST, SlimefunItems.SIFTED_ORE, SlimefunItems.LEAD_DUST, SlimefunItems.SIFTED_ORE, SlimefunItems.SILVER_DUST}, Material.FENCE).register(true, new MultiBlockInteractionHandler() {
            @Override
            public boolean onInteract(final Player p, final MultiBlock mb, final Block b) {
                final SlimefunMachine machine = (SlimefunMachine) SlimefunItem.getByID("ORE_WASHER");
                if (mb.isMultiBlock(machine)) {
                    if (CSCoreLib.getLib().getProtectionManager().canAccessChest(p.getUniqueId(), b, true) && Slimefun.hasUnlocked(p, machine.getItem(), true)) {
                        final Dispenser disp = (Dispenser) b.getRelative(BlockFace.UP).getState();
                        final Inventory inv = disp.getInventory();
                        for (final ItemStack current : inv.getContents()) {
                            if (current != null) {
                                if (SlimefunManager.isItemSimiliar(current, SlimefunItems.SIFTED_ORE, true)) {
                                    ...
                                    if (inv.firstEmpty() != -1 || (SlimefunSetup.legacy_ore_washer && InvUtils.fits(inv, adding))) {
                                        final ItemStack removing = current.clone();
                                        removing.setAmount(1);
                                        inv.removeItem(removing);
                                        inv.addItem(adding);
                                        p.getWorld().playSound(b.getLocation(), Sound.ENTITY_PLAYER_SPLASH, 1.0f, 1.0f);
                                        p.getWorld().playEffect(b.getLocation(), Effect.STEP_SOUND, (Object) Material.WATER);
                                        if (InvUtils.fits(inv, SlimefunItems.STONE_CHUNK)) {
                                            inv.addItem(SlimefunItems.STONE_CHUNK);
                                        }
                                    } else {
                                        Messages.local.sendTranslation(p, "machines.full-inventory", true);
                                    }
                                ...
                                if (SlimefunManager.isItemSimiliar(current, new ItemStack(Material.SAND, 4), false)) {
                                    final ItemStack adding = SlimefunItems.SALT;
                                    if (InvUtils.fits(inv, adding)) {
                                        final ItemStack removing = current.clone();
                                ...
                                if (SlimefunManager.isItemSimiliar(current, SlimefunItems.PULVERIZED_ORE, true)) {
                                    final ItemStack adding = SlimefunItems.PURE_ORE_CLUSTER;
                                    if (InvUtils.fits(inv, adding)) {
                                        final ItemStack removing = current.clone();
                                        removing.setAmount(1);
                                        inv.removeItem(removing);
        ...
        new SlimefunItem(Categories.TOOLS, SlimefunItems.AUTO_SMELT_PICKAXE, "SMELTERS_PICKAXE", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.LAVA_CRYSTAL, SlimefunItems.LAVA_CRYSTAL, SlimefunItems.LAVA_CRYSTAL, null, SlimefunItems.FERROSILICON, null, null, SlimefunItems.FERROSILICON, null}).register(true, new BlockBreakHandler() {
            ...
            public boolean onBlockBreak(final BlockBreakEvent e, final ItemStack item, final int fortune, final List<ItemStack> drops) {
                ...
                int j = -1;
                final List<ItemStack> dropsList = (List<ItemStack>) e.getBlock().getDrops();
        ...
        new Talisman(SlimefunItems.TALISMAN_MAGICIAN, "MAGICIAN_TALISMAN", new ItemStack[]{SlimefunItems.ENDER_LUMP_3, null, SlimefunItems.ENDER_LUMP_3, new ItemStack(Material.ENCHANTMENT_TABLE), SlimefunItems.TALISMAN, new ItemStack(Material.ENCHANTMENT_TABLE), SlimefunItems.ENDER_LUMP_3, null, SlimefunItems.ENDER_LUMP_3}, false, false, "magician", 80).register(true);
        ...
        new SlimefunItem(Categories.PORTABLE, SlimefunItems.RAG, "RAG", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.CLOTH, SlimefunItems.CLOTH, SlimefunItems.CLOTH, new ItemStack(Material.STRING), null, new ItemStack(Material.STRING), SlimefunItems.CLOTH, SlimefunItems.CLOTH, SlimefunItems.CLOTH}).register(true, new ItemInteractionHandler() {
            ...
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack item) {
                if (SlimefunManager.isItemSimiliar(item, SlimefunItems.RAG, true)) {
                    PlayerInventory.consumeItemInHand(p);
                    p.getWorld().playEffect(p.getLocation(), Effect.STEP_SOUND, (Object) Material.WOOL);
        ...
        new SlimefunItem(Categories.TOOLS, SlimefunItems.PICKAXE_OF_CONTAINMENT, "PICKAXE_OF_CONTAINMENT", RecipeType.MAGIC_WORKBENCH, new ItemStack[]{SlimefunItems.FERROSILICON, SlimefunItems.FERROSILICON, SlimefunItems.FERROSILICON, null, SlimefunItems.GILDED_IRON, null, null, SlimefunItems.GILDED_IRON, null}).register(true, new BlockBreakHandler() {
            ...
            public boolean onBlockBreak(final BlockBreakEvent e, final ItemStack item, final int fortune, final List<ItemStack> drops) {
                ...
                final ItemStack spawner = SlimefunItems.BROKEN_SPAWNER.clone();
                final ItemMeta im = spawner.getItemMeta();
                final List<String> lore = im.getLore();
                for (int i = 0; i < lore.size(); ++i) {
                    if (lore.get(i).contains("<Type>")) {
                        lore.set(i, lore.get(i).replace("<Type>", StringUtils.format(((CreatureSpawner) e.getBlock().getState()).getSpawnedType().toString())));
                    }
                }
                im.setLore(lore);
            ...
            public boolean onBlockBreak(final BlockBreakEvent e, final ItemStack item, final int fortune, final List<ItemStack> drops) {
                if (SlimefunManager.isItemSimiliar(e.getPlayer().getInventory().getItemInMainHand(), SlimefunItems.HERCULES_PICKAXE, true) && e.getBlock().getType().toString().endsWith("_ORE")) {
                    if (e.getBlock().getType() == Material.IRON_ORE) {
                        ...
                        for (final ItemStack drop : e.getBlock().getDrops()) {
        ...
        new SlimefunMachine(Categories.MACHINES_1, SlimefunItems.SAW_MILL, "SAW_MILL", new ItemStack[]{null, null, null, new ItemStack(Material.IRON_FENCE), new ItemStack(Material.LOG), new ItemStack(Material.IRON_FENCE), new ItemStack(Material.LOG), new ItemStack(Material.WORKBENCH), new ItemStack(Material.LOG)}, new ItemStack[0], Material.WORKBENCH).register(true, new MultiBlockInteractionHandler() {
            @Override
            public boolean onInteract(final Player p, final MultiBlock mb, final Block b) {
                if (mb.isMultiBlock(SlimefunItem.getByID("SAW_MILL"))) {
                    if (CSCoreLib.getLib().getProtectionManager().canBuild(p.getUniqueId(), b.getRelative(BlockFace.UP), true) && Slimefun.hasUnlocked(p, SlimefunItems.SAW_MILL, true) && (b.getRelative(BlockFace.UP).getType() == Material.LOG || b.getRelative(BlockFace.UP).getType() == Material.LOG_2)) {
                        final Block log = b.getRelative(BlockFace.UP);
                        if (!BlockStorage.hasBlockInfo(log)) {
                            final ItemStack item = (log.getType() == Material.LOG) ? new CustomItem(Material.WOOD, log.getData() % 4, 8) : new CustomItem(Material.WOOD, log.getData() % 2 + 4, 8);
        ...
        new SlimefunMachine(Categories.MACHINES_1, new CustomItem(Material.FIRE, "&4Phantom Item", 0), "SAW_MILL2", new ItemStack[]{null, null, null, new ItemStack(Material.IRON_FENCE), new ItemStack(Material.LOG_2), new ItemStack(Material.IRON_FENCE), new ItemStack(Material.LOG), new ItemStack(Material.WORKBENCH), new ItemStack(Material.LOG)}, new ItemStack[0], Material.WORKBENCH, true).register(true);
        new SlimefunMachine(Categories.MACHINES_1, new CustomItem(Material.FIRE, "&4Phantom Item", 0), "SAW_MILL3", new ItemStack[]{null, null, null, new ItemStack(Material.IRON_FENCE), new ItemStack(Material.LOG), new ItemStack(Material.IRON_FENCE), new ItemStack(Material.LOG_2), new ItemStack(Material.WORKBENCH), new ItemStack(Material.LOG_2)}, new ItemStack[0], Material.WORKBENCH, true).register(true);
        new SlimefunMachine(Categories.MACHINES_1, new CustomItem(Material.FIRE, "&4Phantom Item", 0), "SAW_MILL4", new ItemStack[]{null, null, null, new ItemStack(Material.IRON_FENCE), new ItemStack(Material.LOG_2), new ItemStack(Material.IRON_FENCE), new ItemStack(Material.LOG_2), new ItemStack(Material.WORKBENCH), new ItemStack(Material.LOG_2)}, new ItemStack[0], Material.WORKBENCH, true).register(true);
            ...
            public boolean onInteract(final Player p, final MultiBlock mb, final Block b) {
                if (mb.isMultiBlock(SlimefunItem.getByID("DIGITAL_MINER"))) {
                    if (CSCoreLib.getLib().getProtectionManager().canAccessChest(p.getUniqueId(), b, true) && Slimefun.hasUnlocked(p, SlimefunItems.DIGITAL_MINER, true)) {
                        final Block chestBlock = b.getRelative(BlockFace.UP);
                        if ((!BlockStorage.check(chestBlock.getRelative(BlockFace.WEST), "SOLAR_PANEL") || !BlockStorage.check(chestBlock.getRelative(BlockFace.EAST), "SOLAR_PANEL")) && (!BlockStorage.check(chestBlock.getRelative(BlockFace.NORTH), "SOLAR_PANEL") || !BlockStorage.check(chestBlock.getRelative(BlockFace.SOUTH), "SOLAR_PANEL"))) {
                            return false;
                        }
                        final Chest chest = (Chest) chestBlock.getState();
                        final Inventory inv = chest.getInventory();
                        final List<Location> ores = new ArrayList<>();
                    ...
                    if (CSCoreLib.getLib().getProtectionManager().canAccessChest(p.getUniqueId(), b, true) && Slimefun.hasUnlocked(p, SlimefunItems.ADVANCED_DIGITAL_MINER, true)) {
                        ...
                        if (!ores.isEmpty()) {
                            ...
                            if (ore == Material.COAL_ORE) {
                                ...
                                for (final ItemStack drops : ores.get(0).getBlock().getDrops()) {
                        ...
                        if (CSCoreLib.getLib().getProtectionManager().canAccessChest(p.getUniqueId(), e.getClickedBlock(), true)) {
                            ...
                            for (final ItemStack convert : RecipeType.getRecipeInputs(machine)) {
                                if (convert != null && SlimefunManager.isItemSimiliar(input, convert, true)) {
                                    final ItemStack removing = input.clone();
                                    removing.setAmount(convert.getAmount());
            ...
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack item) {
                if (SlimefunManager.isItemSimiliar(item, SlimefunItems.PICKAXE_OF_THE_SEEKER, true)) {
                    ...
                    if (closest == null) {
                        ...
                        final double l = closest.getX() + 0.5 - p.getLocation().getX();
                        final double w = closest.getZ() + 0.5 - p.getLocation().getZ();
                        final double c = Math.sqrt(l * l + w * w);
                        final double alpha1 = -Math.asin(l / c) / 3.141592653589793 * 180.0;
                        final double alpha2 = Math.acos(w / c) / 3.141592653589793 * 180.0;
                        float yaw;
                        if (alpha2 > 90.0) {
                            yaw = (float) (180.0 - alpha1);
                        } else {
                            yaw = (float) alpha1;
                        }
                        final float pitch = (float) (-Math.atan((closest.getY() - 0.5 - p.getLocation().getY()) / Math.sqrt(l * l + w * w)) * 180.0 / 3.141592653589793);
        ...
        new SlimefunGadget(Categories.MACHINES_1, SlimefunItems.CRUCIBLE, "CRUCIBLE", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{new ItemStack(Material.HARD_CLAY), null, new ItemStack(Material.HARD_CLAY), new ItemStack(Material.HARD_CLAY), null, new ItemStack(Material.HARD_CLAY), new ItemStack(Material.HARD_CLAY), new ItemStack(Material.FLINT_AND_STEEL), new ItemStack(Material.HARD_CLAY)}, new ItemStack[]{new ItemStack(Material.COBBLESTONE, 16), new ItemStack(Material.LAVA_BUCKET), new ItemStack(Material.LEAVES, 16), new ItemStack(Material.WATER_BUCKET), new ItemStack(Material.HARD_CLAY, 12), new ItemStack(Material.LAVA_BUCKET)}).register(true, new ItemInteractionHandler() {
            @Override
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack item) {
                if (e.getClickedBlock() != null) {
                    final SlimefunItem machine = BlockStorage.check(e.getClickedBlock());
        ...
        new JetBoots(SlimefunItems.BILLON_JETBOOTS, "BILLON_JETBOOTS", new ItemStack[]{null, null, null, SlimefunItems.BILLON_INGOT, SlimefunItems.POWER_CRYSTAL, SlimefunItems.BILLON_INGOT, SlimefunItems.STEEL_THRUSTER, SlimefunItems.SMALL_CAPACITOR, SlimefunItems.STEEL_THRUSTER}, 0.45).register(true);
        new JetBoots(SlimefunItems.STEEL_JETBOOTS, "STEEL_JETBOOTS", new ItemStack[]{null, null, null, SlimefunItems.STEEL_INGOT, SlimefunItems.POWER_CRYSTAL, SlimefunItems.STEEL_INGOT, SlimefunItems.STEEL_THRUSTER, SlimefunItems.SMALL_CAPACITOR, SlimefunItems.STEEL_THRUSTER}, 0.5).register(true);
        ...
        new SlimefunItem(Categories.WEAPONS, SlimefunItems.SEISMIC_AXE, "SEISMIC_AXE", RecipeType.MAGIC_WORKBENCH, new ItemStack[]{SlimefunItems.HARDENED_METAL_INGOT, SlimefunItems.HARDENED_METAL_INGOT, null, SlimefunItems.HARDENED_METAL_INGOT, SlimefunItems.STAFF_ELEMENTAL, null, null, SlimefunItems.STAFF_ELEMENTAL, null}).register(true, new ItemInteractionHandler() {
            ...
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack item) {
                if (SlimefunManager.isItemSimiliar(item, SlimefunItems.SEISMIC_AXE, true)) {
                    final List<Block> blocks = p.getLineOfSight(null, 10);
                    for (int i = 0; i < blocks.size(); ++i) {
                        ...
                        b.getWorld().playEffect(ground, Effect.STEP_SOUND, (Object) ground.getBlock().getType());
                        if (ground.getBlock().getRelative(BlockFace.UP).getType() == null || ground.getBlock().getRelative(BlockFace.UP).getType() == Material.AIR) {
                            final FallingBlock block = ground.getWorld().spawnFallingBlock(ground.getBlock().getRelative(BlockFace.UP).getLocation(), ground.getBlock().getType(), ground.getBlock().getData());
                            block.setDropItem(false);
                            block.setVelocity(new Vector(0.0, 0.4 + i * 0.01, 0.0));
                            Variables.blocks.add(block.getUniqueId());
                        }
                        for (final Entity n : ground.getChunk().getEntities()) {
                            if (n instanceof LivingEntity && n.getLocation().distance(ground) <= 2.0 && n.getUniqueId() != p.getUniqueId()) {
                                final Vector vector = n.getLocation().toVector().subtract(p.getLocation().toVector()).normalize().multiply(1.4);
                                vector.setY(0.9);
                                n.setVelocity(vector);
                                if (p.getWorld().getPVP()) {
                                    final EntityDamageByEntityEvent event = new EntityDamageByEntityEvent(p, n, EntityDamageEvent.DamageCause.ENTITY_ATTACK, 6.0);
                                    Bukkit.getPluginManager().callEvent(event);
                                    if (!event.isCancelled()) {
                                        ((LivingEntity) n).damage(6.0);
                                    }
                                }
                            }
                        }
        ...
        new SlimefunMachine(Categories.MACHINES_1, SlimefunItems.JUICER, "JUICER", new ItemStack[]{null, new ItemStack(Material.GLASS), null, null, new ItemStack(Material.NETHER_FENCE), null, null, new CustomItem(Material.DISPENSER, "发射器 (口朝上)", 0), null}, new ItemStack[]{new ItemStack(Material.APPLE), SlimefunItems.APPLE_JUICE, new ItemStack(Material.MELON), SlimefunItems.MELON_JUICE, new ItemStack(Material.CARROT_ITEM), SlimefunItems.CARROT_JUICE, new ItemStack(Material.PUMPKIN), SlimefunItems.PUMPKIN_JUICE}, Material.NETHER_FENCE).register(true, new MultiBlockInteractionHandler() {
            @Override
            public boolean onInteract(final Player p, final MultiBlock mb, final Block b) {
                final SlimefunMachine machine = (SlimefunMachine) SlimefunItem.getByID("JUICER");
                if (mb.isMultiBlock(machine)) {
            ...
            public boolean onBlockPlace(final BlockPlaceEvent e, final ItemStack item) {
                if (SlimefunManager.isItemSimiliar(item, SlimefunItems.REPAIRED_SPAWNER, false)) {
                    ...
                    for (final String line : item.getItemMeta().getLore()) {
                        if (ChatColor.stripColor(line).startsWith("Type: ")) {
                    ...
                    if ((block.getType() == null || block.getType() == Material.AIR) && e.getItem().getType().isBlock()) {
                        ...
                        if (sfItem != null) {
                            if (!SlimefunItem.blockhandler.containsKey(sfItem.getName())) {
                                ...
                                block.getWorld().playEffect(block.getLocation(), Effect.STEP_SOUND, (Object) e.getItem().getType());
        ...
        new SlimefunItem(Categories.MAGIC, SlimefunItems.SCROLL_OF_DIMENSIONAL_TELEPOSITION, "SCROLL_OF_DIMENSIONAL_TELEPOSITION", RecipeType.MAGIC_WORKBENCH, new ItemStack[]{null, SlimefunItems.ENDER_LUMP_3, SlimefunItems.MAGIC_EYE_OF_ENDER, SlimefunItems.ENDER_LUMP_3, SlimefunItems.MAGICAL_BOOK_COVER, SlimefunItems.ENDER_LUMP_3, SlimefunItems.MAGIC_EYE_OF_ENDER, SlimefunItems.ENDER_LUMP_3, null}).register(true, new ItemInteractionHandler() {
            ...
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack item) {
                if (SlimefunManager.isItemSimiliar(item, SlimefunItems.SCROLL_OF_DIMENSIONAL_TELEPOSITION, true)) {
                    for (final Entity n : p.getNearbyEntities(10.0, 10.0, 10.0)) {
        ...
        new SlimefunBow(SlimefunItems.ICY_BOW, "ICY_BOW", new ItemStack[]{null, new ItemStack(Material.STICK), new ItemStack(Material.ICE), SlimefunItems.STAFF_WATER, null, new ItemStack(Material.PACKED_ICE), null, new ItemStack(Material.STICK), new ItemStack(Material.ICE)}).register(true, new BowShootHandler() {
            ...
            public boolean onHit(final EntityDamageByEntityEvent e, final LivingEntity n) {
                if (SlimefunManager.isItemSimiliar(Variables.arrows.get(e.getDamager().getUniqueId()), SlimefunItems.ICY_BOW, true)) {
                    n.getWorld().playEffect(n.getLocation(), Effect.STEP_SOUND, (Object) Material.ICE);
                    n.getWorld().playEffect(n.getEyeLocation(), Effect.STEP_SOUND, (Object) Material.ICE);
        ...
        new SlimefunItem(Categories.MAGIC, SlimefunItems.TOME_OF_KNOWLEDGE_SHARING, "TOME_OF_KNOWLEDGE_SHARING", RecipeType.MAGIC_WORKBENCH, new ItemStack[]{null, new ItemStack(Material.FEATHER), null, new ItemStack(Material.INK_SACK), SlimefunItems.MAGICAL_BOOK_COVER, new ItemStack(Material.GLASS_BOTTLE), null, new ItemStack(Material.BOOK_AND_QUILL), null}).register(true, new ItemInteractionHandler() {
            ...
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack item) {
                ...
                if (SlimefunManager.isItemSimiliar(item, SlimefunItems.TOME_OF_KNOWLEDGE_SHARING, false)) {
                    final List<Research> researches = Research.getResearches(ChatColor.stripColor(item.getItemMeta().getLore().get(1)));
        ...
        new SlimefunItem(Categories.BIRTHDAY, new CustomItem(new MaterialData(Material.CAKE), "&b生日蛋糕"), "BIRTHDAY_CAKE", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{null, new ItemStack(Material.TORCH), null, new ItemStack(Material.SUGAR), new ItemStack(Material.CAKE), new ItemStack(Material.SUGAR), null, null, null}).register(true);
        new SlimefunItem(Categories.CHRISTMAS, SlimefunItems.CHRISTMAS_MILK, "CHRISTMAS_MILK", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{new ItemStack(Material.MILK_BUCKET), new ItemStack(Material.GLASS_BOTTLE), null, null, null, null, null, null, null}, new CustomItem(SlimefunItems.CHRISTMAS_MILK, 4)).register(true);
        ...
        new SlimefunItem(Categories.CHRISTMAS, SlimefunItems.CHRISTMAS_EGG_NOG, "CHRISTMAS_EGG_NOG", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.CHRISTMAS_MILK, new ItemStack(Material.EGG), null, null, null, null, null, null, null}, new CustomItem(SlimefunItems.CHRISTMAS_EGG_NOG, 2)).register(true);
        ...
        new SlimefunItem(Categories.CHRISTMAS, SlimefunItems.CHRISTMAS_CARAMEL, "CHRISTMAS_CARAMEL", RecipeType.SMELTERY, new ItemStack[]{new ItemStack(Material.SUGAR), new ItemStack(Material.SUGAR), null, null, null, null, null, null, null}, new CustomItem(SlimefunItems.CHRISTMAS_CARAMEL, 4)).register(true);
        ...
        new SlimefunItem(Categories.EASTER, SlimefunItems.EASTER_CARROT_PIE, "EASTER_CARROT_PIE", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{new ItemStack(Material.SUGAR), new ItemStack(Material.CARROT_ITEM), new ItemStack(Material.EGG), null, null, null, null, null, null}, new CustomItem(SlimefunItems.EASTER_CARROT_PIE, 2)).register(true);
        new SlimefunItem(Categories.EASTER, SlimefunItems.CHRISTMAS_APPLE_PIE, "EASTER_APPLE_PIE", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{new ItemStack(Material.SUGAR), new ItemStack(Material.APPLE), new ItemStack(Material.EGG), null, null, null, null, null, null}, new CustomItem(SlimefunItems.CHRISTMAS_APPLE_PIE, 2)).register(true);
        new SlimefunItem(Categories.EASTER, SlimefunItems.EASTER_EGG, "EASTER_EGG", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{null, null, null, new MaterialData(Material.INK_SACK, (byte) 10).toItemStack(1), new ItemStack(Material.EGG), new MaterialData(Material.INK_SACK, (byte) 13).toItemStack(1), null, null, null}, new CustomItem(SlimefunItems.EASTER_EGG, 2)).register(true, new ItemInteractionHandler() {
            ...
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack item) {
                if (SlimefunManager.isItemSimiliar(item, SlimefunItems.EASTER_EGG, true)) {
                    ...
                    final List<ItemStack> gifts = new ArrayList<>();
                    for (int i = 0; i < 2; ++i) {
        ...
        SlimefunItem.registerBlockHandler("ANCIENT_PEDESTAL", new SlimefunBlockHandler() {
            ...
            public boolean onBreak(final Player p, final Block b, final SlimefunItem item, final UnregisterReason reason) {
                final Item stack = AncientAltarListener.findItem(b);
                if (stack != null) {
                    p.sendMessage("§c请先拿走物品再拆除祭坛灵柱");
                    return false;
                }
                return true;
            }
        ...
        new SlimefunItem(Categories.ELECTRICITY, SlimefunItems.ENERGY_REGULATOR, "ENERGY_REGULATOR", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.SILVER_INGOT, SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.SILVER_INGOT, SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.SILVER_INGOT, SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.SILVER_INGOT}).register(true, new BlockTicker() {
            ...
            @Override
            public void tick(final Block b, final SlimefunItem item, final Config data) {
        ...
        new SlimefunItem(Categories.ELECTRICITY, SlimefunItems.ENERGYCONNECTOR, "ENERGYCONNECTOR", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.CARBON, SlimefunItems.COPPER_WIDE, SlimefunItems.CARBON, SlimefunItems.COPPER_WIDE, new ItemStack(Material.REDSTONE_BLOCK), SlimefunItems.COPPER_WIDE, SlimefunItems.CARBON, SlimefunItems.COPPER_WIDE, SlimefunItems.CARBON}, new CustomItem(SlimefunItems.ENERGYCONNECTOR, 8)).registerDistibutingCapacitor(true, 0);
        new SlimefunItem(Categories.ELECTRICITY, SlimefunItems.SMALL_CAPACITOR, "SMALL_CAPACITOR", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.DURALUMIN_INGOT, SlimefunItems.REDSTONE_ALLOY, SlimefunItems.DURALUMIN_INGOT, SlimefunItems.SULFATE, SlimefunItems.ENERGYCONNECTOR, SlimefunItems.SULFATE, SlimefunItems.DURALUMIN_INGOT, SlimefunItems.REDSTONE_ALLOY, SlimefunItems.DURALUMIN_INGOT}).registerDistibutingCapacitor(true, 128);
        ...
        new SlimefunItem(Categories.ELECTRICITY, SlimefunItems.SOLAR_GENERATOR, "SOLAR_GENERATOR", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.SOLAR_PANEL, SlimefunItems.SOLAR_PANEL, SlimefunItems.SOLAR_PANEL, SlimefunItems.ALUMINUM_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.ALUMINUM_INGOT, null, SlimefunItems.ALUMINUM_INGOT, null}).register(true, new EnergyTicker() {
            @Override
            public double generateEnergy(final Location l, final SlimefunItem item, final Config data) {
        ...
        new AContainer(Categories.ELECTRICITY, SlimefunItems.ELECTRIC_INGOT_PULVERIZER, "ELECTRIC_INGOT_PULVERIZER", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{null, SlimefunItems.ELECTRIC_ORE_GRINDER, null, SlimefunItems.LEAD_INGOT, SlimefunItems.MEDIUM_CAPACITOR, SlimefunItems.LEAD_INGOT, SlimefunItems.LEAD_INGOT, SlimefunItems.HEATING_COIL, SlimefunItems.LEAD_INGOT}) {
            ...
            @Override
            public void registerDefaultRecipes() {
                this.registerRecipe(3, new ItemStack[]{SlimefunItems.ALUMINUM_INGOT}, new ItemStack[]{SlimefunItems.ALUMINUM_DUST});
                this.registerRecipe(3, new ItemStack[]{SlimefunItems.COPPER_INGOT}, new ItemStack[]{SlimefunItems.COPPER_DUST});
                this.registerRecipe(3, new ItemStack[]{SlimefunItems.GOLD_4K}, new ItemStack[]{SlimefunItems.GOLD_DUST});
                this.registerRecipe(3, new ItemStack[]{new ItemStack(Material.IRON_INGOT)}, new ItemStack[]{SlimefunItems.IRON_DUST});
                this.registerRecipe(3, new ItemStack[]{SlimefunItems.LEAD_INGOT}, new ItemStack[]{SlimefunItems.LEAD_DUST});
                this.registerRecipe(3, new ItemStack[]{SlimefunItems.MAGNESIUM_INGOT}, new ItemStack[]{SlimefunItems.MAGNESIUM_DUST});
                this.registerRecipe(3, new ItemStack[]{SlimefunItems.SILVER_INGOT}, new ItemStack[]{SlimefunItems.SILVER_DUST});
                this.registerRecipe(3, new ItemStack[]{SlimefunItems.TIN_INGOT}, new ItemStack[]{SlimefunItems.TIN_DUST});
                this.registerRecipe(3, new ItemStack[]{SlimefunItems.ZINC_INGOT}, new ItemStack[]{SlimefunItems.ZINC_DUST});
            }
        ...
        new AGenerator(Categories.ELECTRICITY, SlimefunItems.COAL_GENERATOR, "COAL_GENERATOR", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.HEATING_COIL, new ItemStack(Material.FURNACE), SlimefunItems.HEATING_COIL, SlimefunItems.NICKEL_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.NICKEL_INGOT, null, SlimefunItems.NICKEL_INGOT, null}) {
            @Override
            public void registerDefaultRecipes() {
                this.registerFuel(new MachineFuel(8, new MaterialData(Material.COAL, (byte) 0).toItemStack(1)));
                this.registerFuel(new MachineFuel(8, new MaterialData(Material.COAL, (byte) 1).toItemStack(1)));
                this.registerFuel(new MachineFuel(80, new ItemStack(Material.COAL_BLOCK)));
                this.registerFuel(new MachineFuel(12, new ItemStack(Material.BLAZE_ROD)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.LOG, (byte) 0).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.LOG, (byte) 1).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.LOG, (byte) 2).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.LOG, (byte) 3).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.LOG_2, (byte) 0).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.LOG_2, (byte) 1).toItemStack(1)));
        ...
        new AGenerator(Categories.ELECTRICITY, SlimefunItems.BIO_REACTOR, "BIO_REACTOR", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.HEATING_COIL, SlimefunItems.COMPOSTER, SlimefunItems.HEATING_COIL, SlimefunItems.ALUMINUM_BRASS_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.ALUMINUM_BRASS_INGOT, null, SlimefunItems.ALUMINUM_BRASS_INGOT, null}) {
            @Override
            public void registerDefaultRecipes() {
                this.registerFuel(new MachineFuel(2, new ItemStack(Material.ROTTEN_FLESH)));
                this.registerFuel(new MachineFuel(2, new ItemStack(Material.SPIDER_EYE)));
                this.registerFuel(new MachineFuel(2, new ItemStack(Material.BONE)));
                this.registerFuel(new MachineFuel(3, new ItemStack(Material.APPLE)));
                this.registerFuel(new MachineFuel(3, new ItemStack(Material.MELON)));
                this.registerFuel(new MachineFuel(27, new ItemStack(Material.MELON_BLOCK)));
                this.registerFuel(new MachineFuel(3, new ItemStack(Material.PUMPKIN)));
                this.registerFuel(new MachineFuel(3, new ItemStack(Material.PUMPKIN_SEEDS)));
                this.registerFuel(new MachineFuel(3, new ItemStack(Material.MELON_SEEDS)));
                this.registerFuel(new MachineFuel(3, new ItemStack(Material.WHEAT)));
                this.registerFuel(new MachineFuel(3, new ItemStack(Material.SEEDS)));
                this.registerFuel(new MachineFuel(3, new ItemStack(Material.CARROT_ITEM)));
                this.registerFuel(new MachineFuel(3, new ItemStack(Material.POTATO_ITEM)));
                this.registerFuel(new MachineFuel(3, new ItemStack(Material.SUGAR_CANE)));
                this.registerFuel(new MachineFuel(3, new ItemStack(Material.NETHER_STALK)));
                this.registerFuel(new MachineFuel(2, new ItemStack(Material.YELLOW_FLOWER)));
                this.registerFuel(new MachineFuel(2, new ItemStack(Material.RED_ROSE)));
                this.registerFuel(new MachineFuel(2, new ItemStack(Material.RED_MUSHROOM)));
                this.registerFuel(new MachineFuel(2, new ItemStack(Material.BROWN_MUSHROOM)));
                this.registerFuel(new MachineFuel(2, new ItemStack(Material.VINE)));
                this.registerFuel(new MachineFuel(2, new ItemStack(Material.CACTUS)));
                this.registerFuel(new MachineFuel(2, new ItemStack(Material.WATER_LILY)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.LEAVES, (byte) 0).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.LEAVES, (byte) 1).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.LEAVES, (byte) 2).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.LEAVES, (byte) 3).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.LEAVES_2, (byte) 0).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.LEAVES_2, (byte) 1).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.SAPLING, (byte) 0).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.SAPLING, (byte) 1).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.SAPLING, (byte) 2).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.SAPLING, (byte) 3).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.SAPLING, (byte) 4).toItemStack(1)));
                this.registerFuel(new MachineFuel(1, new MaterialData(Material.SAPLING, (byte) 5).toItemStack(1)));
            }
        ...
        new SlimefunItem(Categories.GPS, SlimefunItems.GPS_TRANSMITTER, "GPS_TRANSMITTER", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{null, null, SlimefunItems.ELECTRO_MAGNET, SlimefunItems.STEEL_INGOT, SlimefunItems.ADVANCED_CIRCUIT_BOARD, SlimefunItems.STEEL_INGOT, SlimefunItems.STEEL_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.STEEL_INGOT}).registerChargeableBlock(true, 16, new BlockTicker() {
            @Override
            public void tick(final Block b, final SlimefunItem item, final Config data) {
                final int charge = ChargableBlock.getCharge(b);
                if (charge > 0) {
        ...
        new SlimefunItem(Categories.GPS, SlimefunItems.GPS_CONTROL_PANEL, "GPS_CONTROL_PANEL", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{null, null, SlimefunItems.ELECTRO_MAGNET, SlimefunItems.COBALT_INGOT, SlimefunItems.ADVANCED_CIRCUIT_BOARD, SlimefunItems.COBALT_INGOT, SlimefunItems.ALUMINUM_BRASS_INGOT, SlimefunItems.ALUMINUM_BRASS_INGOT, SlimefunItems.ALUMINUM_BRASS_INGOT}).register(true, new ItemInteractionHandler() {
            @Override
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack stack) {
                if (e.getClickedBlock() == null) {
                    return false;
                }
        ...
        new ProgrammableAndroid(Categories.ANDROID, SlimefunItems.PROGRAMMABLE_ANDROID, "PROGRAMMABLE_ANDROID", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.PLASTIC_SHEET, SlimefunItems.ANDROID_MEMORY_CORE, SlimefunItems.PLASTIC_SHEET, SlimefunItems.COAL_GENERATOR, SlimefunItems.ELECTRIC_MOTOR, new ItemStack(Material.CHEST), SlimefunItems.PLASTIC_SHEET, SlimefunItems.PLASTIC_SHEET, SlimefunItems.PLASTIC_SHEET}) {
            @Override
        ...
        new ProgrammableAndroid(Categories.ANDROID, SlimefunItems.PROGRAMMABLE_ANDROID_FISHERMAN, "PROGRAMMABLE_ANDROID_FISHERMAN", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{null, null, null, new ItemStack(Material.FISHING_ROD), SlimefunItems.PROGRAMMABLE_ANDROID, new ItemStack(Material.FISHING_ROD), null, SlimefunItems.ELECTRIC_MOTOR, null}) {
            @Override
            public AndroidType getAndroidType() {
        ...
        new ProgrammableAndroid(Categories.ANDROID, SlimefunItems.PROGRAMMABLE_ANDROID_2, "PROGRAMMABLE_ANDROID_2", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.PLASTIC_SHEET, SlimefunItems.ANDROID_MEMORY_CORE, SlimefunItems.PLASTIC_SHEET, SlimefunItems.COMBUSTION_REACTOR, SlimefunItems.PROGRAMMABLE_ANDROID, new ItemStack(Material.CHEST), SlimefunItems.PLASTIC_SHEET, SlimefunItems.POWER_CRYSTAL, SlimefunItems.PLASTIC_SHEET}) {
            @Override
            public AndroidType getAndroidType() {
                return AndroidType.NONE;
            }
        ...
        new ProgrammableAndroid(Categories.ANDROID, SlimefunItems.PROGRAMMABLE_ANDROID_2_BUTCHER, "PROGRAMMABLE_ANDROID_2_BUTCHER", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{null, SlimefunItems.GPS_TRANSMITTER, null, new ItemStack(Material.DIAMOND_SWORD), SlimefunItems.PROGRAMMABLE_ANDROID_2, new ItemStack(Material.DIAMOND_SWORD), null, SlimefunItems.ELECTRIC_MOTOR, null}) {
            @Override
            public AndroidType getAndroidType() {
                return AndroidType.FIGHTER;
            }
        ...
        new ProgrammableAndroid(Categories.ANDROID, SlimefunItems.PROGRAMMABLE_ANDROID_3_FISHERMAN, "PROGRAMMABLE_ANDROID_3_FISHERMAN", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{null, null, null, new ItemStack(Material.FISHING_ROD), SlimefunItems.PROGRAMMABLE_ANDROID_3, new ItemStack(Material.FISHING_ROD), null, SlimefunItems.ELECTRIC_MOTOR, null}) {
            @Override
            public AndroidType getAndroidType() {
                return AndroidType.FISHERMAN;
            }
            ...
            public boolean onRightClick(final ItemUseEvent e, final Player p, final ItemStack item) {
                if (SlimefunManager.isItemSimiliar(e.getItem(), SlimefunItems.INFERNAL_BONEMEAL, true)) {
                    if (e.getClickedBlock() != null && e.getClickedBlock().getType().equals(Material.NETHER_WARTS) && e.getClickedBlock().getData() < 3) {
                        ...
                        e.getClickedBlock().getWorld().playEffect(e.getClickedBlock().getLocation(), Effect.STEP_SOUND, (Object) Material.REDSTONE_BLOCK);
                        PlayerInventory.consumeItemInHand(p);
                    }
                    return true;
                }
        ...
        final RainbowTicker rainbow = new RainbowTicker();
        ...
        final RainbowTicker xmas = new RainbowTicker(13, 14);
        ...
        final RainbowTicker valentine = new RainbowTicker(2, 6, 10);
        ...
        new AGenerator(Categories.ELECTRICITY, SlimefunItems.LAVA_GENERATOR, "LAVA_GENERATOR", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{null, SlimefunItems.GOLD_16K, null, SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.HEATING_COIL, SlimefunItems.DAMASCUS_STEEL_INGOT, SlimefunItems.HEATING_COIL}) {
            @Override
            public void registerDefaultRecipes() {
                this.registerFuel(new MachineFuel(40, new ItemStack(Material.LAVA_BUCKET)));
            }
        ...
        new AGenerator(Categories.ELECTRICITY, SlimefunItems.COMBUSTION_REACTOR, "COMBUSTION_REACTOR", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{null, SlimefunItems.STEEL_INGOT, null, SlimefunItems.STEEL_INGOT, SlimefunItems.ELECTRIC_MOTOR, SlimefunItems.STEEL_INGOT, SlimefunItems.HEATING_COIL, SlimefunItems.STEEL_INGOT, SlimefunItems.HEATING_COIL}) {
            @Override
            public void registerDefaultRecipes() {
                this.registerFuel(new MachineFuel(30, SlimefunItems.BUCKET_OF_OIL));
                this.registerFuel(new MachineFuel(90, SlimefunItems.BUCKET_OF_FUEL));
            }
        ...
        new SlimefunItem(Categories.MAGIC, SlimefunItems.INFUSED_HOPPER, "INFUSED_HOPPER", RecipeType.ANCIENT_ALTAR, new ItemStack[]{new ItemStack(Material.OBSIDIAN), SlimefunItems.RUNE_EARTH, new ItemStack(Material.HOPPER), SlimefunItems.RUNE_ENDER, SlimefunItems.INFUSED_MAGNET, SlimefunItems.RUNE_ENDER, new ItemStack(Material.HOPPER), SlimefunItems.RUNE_EARTH, new ItemStack(Material.OBSIDIAN)}).register(true, new BlockTicker() {
            ...
            public void tick(final Block b, final SlimefunItem item, final Config data) {
                ...
                final ArmorStand hologram = InfusedHopper.getArmorStand(b, true);
                boolean sound = false;
                for (final Entity n : hologram.getNearbyEntities(3.5, 3.5, 3.5)) {
                    if (n instanceof Item && !n.hasMetadata("no_pickup") && n.getLocation().distance(hologram.getLocation()) > 0.4) {
                        n.setVelocity(new Vector(0.0, 0.1, 0.0));
                        n.teleport(hologram);
                        sound = true;
                    }
                }
                if (sound) {
                    b.getWorld().playSound(b.getLocation(), Sound.ENTITY_ENDERMEN_TELEPORT, 5.0f, 2.0f);
                }
            }
        ...
        new AReactor(Categories.ELECTRICITY, SlimefunItems.NUCLEAR_REACTOR, "NUCLEAR_REACTOR", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.BLISTERING_INGOT_3, SlimefunItems.CARBONADO_EDGED_CAPACITOR, SlimefunItems.BLISTERING_INGOT_3, SlimefunItems.REINFORCED_PLATE, SlimefunItems.COOLING_UNIT, SlimefunItems.REINFORCED_PLATE, SlimefunItems.LEAD_INGOT, SlimefunItems.REINFORCED_PLATE, SlimefunItems.LEAD_INGOT}) {
            ...
            @Override
            public void registerDefaultRecipes() {
                this.registerFuel(new MachineFuel(1200, SlimefunItems.URANIUM, SlimefunItems.NEPTUNIUM));
                this.registerFuel(new MachineFuel(600, SlimefunItems.NEPTUNIUM, SlimefunItems.PLUTONIUM));
                this.registerFuel(new MachineFuel(1500, SlimefunItems.BOOSTED_URANIUM, null));
            }
            ...
            public String[] getMessage() {
                return new String[]{"", "&r这里可以放入放射性燃料, 例如:", "&2铀 &r或 &a镎"};
        ...
        new AReactor(Categories.ELECTRICITY, SlimefunItems.NETHERSTAR_REACTOR, "NETHERSTAR_REACTOR", RecipeType.ENHANCED_CRAFTING_TABLE, new ItemStack[]{SlimefunItems.BOOSTED_URANIUM, SlimefunItems.CARBONADO_EDGED_CAPACITOR, SlimefunItems.BOOSTED_URANIUM, SlimefunItems.REINFORCED_PLATE, new ItemStack(Material.NETHER_STAR), SlimefunItems.REINFORCED_PLATE, SlimefunItems.CORINTHIAN_BRONZE_INGOT, SlimefunItems.REINFORCED_PLATE, SlimefunItems.CORINTHIAN_BRONZE_INGOT}) {
            ...
            @Override
            public void registerDefaultRecipes() {
                this.registerFuel(new MachineFuel(1800, new ItemStack(Material.NETHER_STAR)));
            }
            ...
            @Override
            public String[] getMessage() {
                return new String[]{"", "&r这里仅可以放入下界之星"};
